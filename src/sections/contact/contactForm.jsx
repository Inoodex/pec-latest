...
//             <div className="mx-auto w-full rounded-3xl border border-gray-100 bg-gray-100 p-5 md:p-5">
...
//                     <button
//                         type="submit"
//                         className="flex w-full items-center justify-center gap-2 rounded-xl bg-brand-primary hover:bg-brand-accent cursor-pointer px-6 py-3 text-sm font-medium text-white transition-all md:text-base"
//                     >
//                         <Send size={18} />
//                         Send Message
//                     </button>
...
//                 ...formData,
//                 phone: "", // Adding empty phone field to satisfy backend requirement
//                 type: "contact",
//             });
//             if (response?.success) {
